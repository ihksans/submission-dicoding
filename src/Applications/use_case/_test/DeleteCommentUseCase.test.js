...
describe('Delete Comment Use Case', ()=>{
    it('should orchestrating the delete comment action correctly', async()=>{
        ...
        // mocking
        mockCommentRepository.deleteComment = jest.fn().mockImplementation(()=> Promise.resolve(response))
        ...
        // action
        const { isDelete } = await deleteCommentUseCase.execute({id: id, ownerId: ownerId})
